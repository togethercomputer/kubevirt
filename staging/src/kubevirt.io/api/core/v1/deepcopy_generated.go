...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverlayVolumeSource) DeepCopyInto(out *OverlayVolumeSource) {
	*out = *in
	if in.BackingPVC != nil {
		in, out := &in.BackingPVC, &out.BackingPVC
		*out = new(PersistentVolumeClaimVolumeSource)
		**out = **in
	}
	if in.BackingHostPath != nil {
		in, out := &in.BackingHostPath, &out.BackingHostPath
		*out = new(corev1.HostPathVolumeSource)
		(*in).DeepCopyInto(*out)
	}
	if in.TargetHostPath != nil {
		in, out := &in.TargetHostPath, &out.TargetHostPath
		*out = new(corev1.HostPathVolumeSource)
		(*in).DeepCopyInto(*out)
	}
	if in.TargetPVC != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverlayVolumeSource.
func (in *OverlayVolumeSource) DeepCopy() *OverlayVolumeSource {
	if in == nil {
		return nil
	}
	out := new(OverlayVolumeSource)
	in.DeepCopyInto(out)
	return out
}
